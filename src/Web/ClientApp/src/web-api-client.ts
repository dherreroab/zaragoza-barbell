...
export class ContactMailClient {
  ...
  sendContactMail(command: CreateContactMailCommand): Promise<number> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processContactMailItem(_response);
    });
  }

  protected processContactMailItem(response: Response): Promise<number> {
...
export class CreateContactMailCommand implements ICreateContactMailCommand {
  name!: string;
  email!: string;
  message!: string;

  constructor(data?: ICreateContactMailCommand) {
    if (data) {
  ...
  static fromJS(data: any): CreateContactMailCommand {
    data = typeof data === "object" ? data : {};
    let result = new CreateContactMailCommand();
    result.init(data);
    return result;
  }
...
export interface ICreateContactMailCommand {
  name: string;
  email: string;
  message: string;
}
